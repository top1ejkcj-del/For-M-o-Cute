...
const fullText1 = splitLines("Gửi Kun cute", 3);
const fullText2 = splitLines("Mong kun Luôn Cười Tươi Và Vui Vẻ Nhé", 3);
const fullText3 = splitLines("Valentine Vui Và Hạnh Phúc Nhé ", 3);
const fullText4 = splitLines("Cho Xin Thểm ảnh Để Ngắm Nữa Được Hơm :3", 3);
